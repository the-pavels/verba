...
This document records the release security review completed on 2026-07-21 for candidate 1.0.1 (14). Rerun `./scripts/security-check.sh` and review this document whenever dependencies, signing, entitlements, networking, secret storage, logging, or generated bindings change.
