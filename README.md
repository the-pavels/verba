...
Verba uses a Rust core with a native Swift and AppKit interface. Run the complete local check before submitting a change:
...
- [Building and releasing](RELEASE.md)
